...
public void OpenStatisticsMenu(int client)
{
	...
	// ELO Leaderboard / admin rename / admin adjust moved to their own "!elo" menu in the
	// standalone elo_ranking plugin (2026-09-15) - no longer nested under Statistics.
